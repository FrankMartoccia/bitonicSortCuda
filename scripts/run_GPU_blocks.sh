...
configurations=(
    "BITONIC_SORT_THREADS=32 BITONIC_SORT_BLOCKS=1"
    "BITONIC_SORT_THREADS=32 BITONIC_SORT_BLOCKS=64"
    "BITONIC_SORT_THREADS=64 BITONIC_SORT_BLOCKS=256"
    "BITONIC_SORT_THREADS=64 BITONIC_SORT_BLOCKS=1024"
    "BITONIC_SORT_THREADS=128 BITONIC_SORT_BLOCKS=4096"
    "BITONIC_SORT_THREADS=256 BITONIC_SORT_BLOCKS=4096"
    "BITONIC_SORT_THREADS=384 BITONIC_SORT_BLOCKS=4096"
    "BITONIC_SORT_THREADS=384 BITONIC_SORT_BLOCKS=8192"
    "BITONIC_SORT_THREADS=512 BITONIC_SORT_BLOCKS=8192"
...
for idx in "${!configurations[@]}"; do
    ...
    echo "constexpr int MAX_SHARED_MEMORY_SIZE = 49152;" >> "$CONSTANTS_FILE"
    echo "" >> "$CONSTANTS_FILE"
