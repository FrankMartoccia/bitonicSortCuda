...
constexpr int THREADS_BITONIC_SORT = 512;  // Number of threads to use in the Bitonic Sort kernel
...
constexpr int THREADS_GLOBAL_MERGE = 1024;   // Number of threads to use in the global merge kernel
