...
constexpr int BITONIC_SORT_BLOCKS = 1;
...
constexpr int MERGE_GLOBAL_THREADS = 32;   // Number of threads to use in the global merge kernel
// constexpr int ELEMENTS_GLOBAL_MERGE = 4;     // Number of elements processed per thread in global merge
constexpr int MERGE_GLOBAL_BLOCKS = 1;
...
constexpr int MERGE_LOCAL_THREADS = 32;     // Number of threads to use in the local merge kernel
// constexpr int ELEMENTS_LOCAL_MERGE = 8;       // Number of elements processed per thread in local merge
constexpr int MERGE_LOCAL_BLOCKS = 1;
