...
constexpr int MERGE_GLOBAL_THREADS = 768;   // Number of threads to use in the global merge kernel
...
constexpr int MERGE_LOCAL_THREADS = 768;     // Number of threads to use in the local merge kernel
