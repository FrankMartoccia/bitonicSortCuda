...
// "tableLen" - Total length of the data table being sorted.
...
// "threadsKernel" - Number of threads used in the kernel.
...
// "keysInput" - Input array of keys to be sorted.
// "keysOutput" - Output array for storing the sorted keys.
// "tableLen" - Length of the data table.
// "threadsBitonicSort" - Number of threads used for sorting.
// "elemsBitonicSort" - Number of elements each thread will process.
...
// "threadsMerge" - Number of threads used for merging.
// "elemsMerge" - Number of elements each thread will process during merge.
